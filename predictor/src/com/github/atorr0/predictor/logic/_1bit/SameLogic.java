...
/**
 * Simple prediction logic that returns the underlying Logic.
 *
 * @author https://github.com/atorr0
 */
public class SameLogic extends _1BitStandaloneLogic {

	protected _1BitStandaloneLogic delegateLogic;

	public SameLogic(final _1BitStandaloneLogic logic) {
		delegateLogic = logic;
	}
